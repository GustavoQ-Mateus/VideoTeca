                ...
                <tr key={film.id} className="hover:bg-[#F5F7FA] transition-colors group">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="w-7 h-7 rounded-[6px] hover:bg-[#E8F2FC] flex items-center justify-center text-[#0066B3] transition-colors" aria-label={`Ver cópias de ${film.title}`}>
