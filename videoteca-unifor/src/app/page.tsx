      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-1 flex-1" aria-label="Navegação principal">
            {["Catálogo", "Eventos", "Sobre"].map(item => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {featuredFilms.map(film => (
              <div key={film.id} className="film-card bg-[#F5F7FA] rounded-[18px] overflow-hidden group border border-[#E2E8F0]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {upcomingEvents.map(event => (
              <div key={event.id} className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-[18px] p-5 hover:bg-white/15 transition-colors cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              {["Catálogo", "Eventos", "Sobre", "Contato"].map(l => (
                <Link key={l} href="#" className="block text-sm text-white/60 hover:text-white py-1 transition-colors">{l}</Link>
              ))}
            </div>
            <div>
